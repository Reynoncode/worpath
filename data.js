...
const LEVELS = [
  ...
  // ╚══════════════════════════════════════════════════╝
  {
    ...
    quizzes: [
     ...
     // ─────────────────────── QUIZ 1 — Peşələr ───────────────────────
[
{ en: 'actor',     tr: 'aktyor',       wrong: 'rejissor',  wen: 'director',   def: 'a person who performs in movies or theatre'    },
{ en: 'actress',   tr: 'aktrisa',      wrong: 'rəqqasə',   wen: 'singer',     def: 'a woman who performs in movies or theatre'     },
{ en: 'adult',     tr: 'yetkin',       wrong: 'uşaq',      wen: 'teenager',   def: 'a fully grown person, not a child'             },
{ en: 'artist',    tr: 'rəssam',       wrong: 'musiqiçi',  wen: 'painter',    def: 'a person who makes paintings or drawings'      },
{ en: 'dancer',    tr: 'rəqqas',       wrong: 'müğənni',   wen: 'singer',     def: 'a person who moves their body to music'        },
{ en: 'doctor',    tr: 'həkim',        wrong: 'müəllim',   wen: 'nurse',      def: 'a person who treats sick people'               },
{ en: 'driver',    tr: 'sürücü',       wrong: 'pilot',     wen: 'passenger',  def: 'a person who operates a car or bus'            },
{ en: 'farmer',    tr: 'əkinçi',       wrong: 'balıqçı',   wen: 'gardener',   def: 'a person who grows food on land'               },
{ en: 'nurse',     tr: 'tibb bacısı',  wrong: 'həkim',     wen: 'doctor',     def: 'a person who helps sick people in hospital'    },
{ en: 'player',    tr: 'oyunçu',       wrong: 'məşqçi',    wen: 'coach',      def: 'a person who takes part in a sport or game'   },
{ en: 'policeman', tr: 'polis',        wrong: 'gözətçi',   wen: 'guard',      def: 'a person whose job is to keep people safe'    },
{ en: 'scientist', tr: 'alim',         wrong: 'mühəndis',  wen: 'engineer',   def: 'a person who studies and tests how things work'},
{ en: 'singer',    tr: 'müğənni',      wrong: 'rəqqas',    wen: 'dancer',     def: 'a person who makes music with their voice'    },
{ en: 'student',   tr: 'tələbə',       wrong: 'müəllim',   wen: 'teacher',    def: 'a person who studies at school or university' },
{ en: 'teacher',   tr: 'müəllim',      wrong: 'direktor',  wen: 'professor',  def: 'a person who teaches students in a class'     },
{ en: 'tourist',   tr: 'turist',       wrong: 'səfir',     wen: 'traveller',  def: 'a person who visits places for fun'           },
{ en: 'visitor',   tr: 'ziyarətçi',    wrong: 'sakin',     wen: 'resident',   def: 'a person who comes to see a place or someone' },
{ en: 'waiter',    tr: 'ofisiant',     wrong: 'aşpaz',     wen: 'chef',       def: 'a person who brings food to your table'       },
{ en: 'worker',    tr: 'işçi',         wrong: 'müdir',     wen: 'manager',    def: 'a person who does a job for money'            },
{ en: 'writer',    tr: 'yazıçı',       wrong: 'jurnalist', wen: 'reporter',   def: 'a person who creates books or stories'        },
],
...
// ─────────────────────── QUIZ 3 — Ailə ───────────────────────
[
  { en: 'aunt', tr: 'xala', wrong: 'nənə', wen: 'grandmother', def: 'your father\'s or mother\'s sister' },
  { en: 'boyfriend', tr: 'oğlan dostu', wrong: 'qardaş', wen: 'brother', def: 'a boy or man who is in a romantic relationship with you' },
  { en: 'brother', tr: 'qardaş', wrong: 'bacı', wen: 'sister', def: 'a male sibling' },
  { en: 'cousin', tr: 'əmiuşağı', wrong: 'nəvə', wen: 'grandchild', def: 'the child of your uncle or aunt' },
  { en: 'dad', tr: 'ata', wrong: 'baba', wen: 'grandfather', def: 'informal word for father' },
  { en: 'daughter', tr: 'qız övlad', wrong: 'oğul', wen: 'son', def: 'a female child' },
  { en: 'family', tr: 'ailə', wrong: 'qrup', wen: 'group', def: 'a group of people who are related to each other' },
  { en: 'father', tr: 'ata', wrong: 'ana', wen: 'mother', def: 'a male parent' },
  { en: 'girlfriend', tr: 'qız dostu', wrong: 'oğlan dostu', wen: 'boyfriend', def: 'a girl or woman who is in a romantic relationship with you' },
  { en: 'grandfather', tr: 'baba', wrong: 'əmi', wen: 'uncle', def: 'your father\'s or mother\'s father' },
  { en: 'grandmother', tr: 'nənə', wrong: 'xala', wen: 'aunt', def: 'your father\'s or mother\'s mother' },
  ...
  { en: 'mum', tr: 'ana', wrong: 'baba', wen: 'dad', def: 'informal word for mother' },
  { en: 'parent', tr: 'valideyn', wrong: 'müəllim', wen: 'teacher', def: 'a mother or father' },
  { en: 'sister', tr: 'bacı', wrong: 'qardaş', wen: 'brother', def: 'a female sibling' },
  { en: 'son', tr: 'oğul', wrong: 'qız övlad', wen: 'daughter', def: 'a male child' },
  { en: 'uncle', tr: 'əmi', wrong: 'baba', wen: 'grandfather', def: 'your father\'s or mother\'s brother' },
  { en: 'wife', tr: 'arvad', wrong: 'ər', wen: 'husband', def: 'a married woman' },
],

// ─────────────────────── QUIZ 4 — Bədən ───────────────────────
[
  { en: 'arm', tr: 'qol', wrong: 'ayaq', wen: 'leg', def: 'the part of the body from the shoulder to the hand' },
  { en: 'body', tr: 'bədən', wrong: 'üz', wen: 'face', def: 'the whole physical structure of a person' },
  { en: 'ear', tr: 'qulaq', wrong: 'göz', wen: 'eye', def: 'the part of the body that you hear with' },
  { en: 'eye', tr: 'göz', wrong: 'qulaq', wen: 'ear', def: 'the part of the body that you see with' },
  { en: 'face', tr: 'üz', wrong: 'baş', wen: 'head', def: 'the front part of the head with eyes, nose and mouth' },
  { en: 'foot', tr: 'ayaq', wrong: 'əl', wen: 'hand', def: 'the part of the body at the end of the leg' },
  { en: 'hair', tr: 'saç', wrong: 'qaş', wen: 'eyebrow', def: 'the thin threads that grow on your head' },
  { en: 'hand', tr: 'əl', wrong: 'qol', wen: 'arm', def: 'the part of the body at the end of the arm' },
  { en: 'head', tr: 'baş', wrong: 'boyun', wen: 'neck', def: 'the top part of the body that contains the brain' },
  { en: 'leg', tr: 'ayaq', wrong: 'qol', wen: 'arm', def: 'the part of the body from the hip to the foot' },
  { en: 'mouth', tr: 'ağız', wrong: 'burun', wen: 'nose', def: 'the part of the face used for eating and speaking' },
  { en: 'nose', tr: 'burun', wrong: 'ağız', wen: 'mouth', def: 'the part of the face used for smelling and breathing' },
  { en: 'tooth', tr: 'diş', wrong: 'dil', wen: 'tongue', def: 'one of the hard white parts inside your mouth' },
  { en: 'back', tr: 'kürək', wrong: 'qarın', wen: 'stomach', def: 'the rear part of the body from the shoulders to the hips' },
  { en: 'bottom', tr: 'oturacaq', wrong: 'üst', wen: 'top', def: 'the part of the body you sit on' },
  { en: 'skin', tr: 'dəri', wrong: 'sümük', wen: 'bone', def: 'the outer covering of the human body' },
  { en: 'health', tr: 'sağlamlıq', wrong: 'xəstəlik', wen: 'illness', def: 'the condition of being well and free from sickness' },
  { en: 'diet', tr: 'pəhriz', wrong: 'idman', wen: 'exercise', def: 'the food and drink that a person usually eats' },
  { en: 'exercise', tr: 'məşq', wrong: 'istirahət', wen: 'rest', def: 'physical activity to keep the body healthy' },
  { en: 'born', tr: 'doğulmuş', wrong: 'ölmüş', wen: 'dead', def: 'brought into life' },
],
...
[
  ...
  { en: 'sorry',        tr: 'üzr istəmək',       wrong: 'razı olmaq'    },
...
[
  ...
  { en: 'pretty',      tr: 'qəşəng',             wrong: 'çirkin'        },
...
[
  ...
  { en: 'dish',        tr: 'təam',               wrong: 'dadsız'        },
  { en: 'food',        tr: 'qida',               wrong: 'içki'          },
  { en: 'snack',       tr: 'qəlyanaltı',         wrong: 'nahar'         },
  { en: 'butter',      tr: 'kərə yağı',          wrong: 'pendir'        },
  { en: 'diet',        tr: 'pəhriz',             wrong: 'resept'        },
  { en: 'cooking',     tr: 'bişirmək',           wrong: 'yemək'    },
  { en: 'recipe',      tr: 'resept',             wrong: 'menyu'          },
],
...
[
  ...
  { en: 'juice',       tr: 'meyvə şirəsi',       wrong: 'qazlı su'      },
  ...
  { en: 'lunch',       tr: 'nahar',              wrong: 'başlatmaq'     },
  { en: 'meal',        tr: 'yemək',              wrong: 'qəlyanaltı'    },
  { en: 'menu',        tr: 'menyu',              wrong: 'resept'        },
...
[
  ...
  { en: 'dark',        tr: 'qaranlıq',           wrong: 'açıq'          },
  { en: 'light',       tr: 'parlaq',             wrong: 'tünd'          },
  { en: 'bright',      tr: 'parlaq',             wrong: 'solğun'        },
  { en: 'pale',        tr: 'solğun',             wrong: 'parlaq'        },
  { en: 'deep',        tr: 'dərin',              wrong: 'açıq'          },
  { en: 'shade',       tr: 'kölgə',              wrong: 'rəngsiz'       },
  { en: 'colourful',   tr: 'rəngli',             wrong: 'tünd'          },
],
...
[
  ...
  { en: 'number',      tr: 'nömrə',              wrong: 'sıra'          },
  { en: 'half',        tr: 'yarım',              wrong: 'tam'           },
  { en: 'quarter',     tr: 'rüb',                wrong: 'yarım'         },
...
[
  ...
  { en: 'bottle',      tr: 'şüşə',               wrong: 'stəkan'        },
  ...
  { en: 'lamp',        tr: 'lampa',              wrong: 'pəncərə'       },
  { en: 'machine',     tr: 'maşın',              wrong: 'alət'          },
  { en: 'paper',       tr: 'kağız',              wrong: 'dəftər'        },
  { en: 'pen',         tr: 'qələm',              wrong: 'karandaş'      },
  { en: 'pencil',      tr: 'karandaş',           wrong: 'qələm'         },
  { en: 'picture',     tr: 'şəkil',              wrong: 'poster'        },
  { en: 'plant',       tr: 'bitki',              wrong: 'çiçək'         },
  { en: 'shower',      tr: 'duş',                wrong: 'vanna'         },
  { en: 'window',      tr: 'pəncərə',            wrong: 'qapı'          },
  { en: 'upstairs',    tr: 'üst mərtəbədə',      wrong: 'alt mərtəbədə' },
  { en: 'downstairs',  tr: 'alt mərtəbədə',      wrong: 'üst mərtəbədə' },
...
[
  ...
  { en: 'market',       tr: 'mağaza',             wrong: 'supermarket'    },
...
[
  ...
  { en: 'floor',        tr: 'mərtəbə',            wrong: 'tavan'          },
  { en: 'space',        tr: 'kainat',             wrong: 'yer'            },
  { en: 'top',          tr: 'zirvə',              wrong: 'ətək'           },
  { en: 'bottom',       tr: 'dib',                wrong: 'dayaz'          },
],
